...
Entry.ITPLE = {
    ...
    setZero() {
        // 네오픽셀 캐시 초기화를 위해 하드웨어 모듈 reset 호출
        if (Entry.hw.hwModule && Entry.hw.hwModule.reset) {
            Entry.hw.hwModule.reset();
        }
        ...
        if (!Entry.hw.sendQueue.SET) {
            ...
            keySet.forEach((key) => {
                // 네오픽셀 포트(9, 100~103)는 제거
                const portNum = parseInt(key);
                if (portNum === 9 || (portNum >= 100 && portNum <= 103)) {
    ...
    return {
        ko: {
            template: {
                ...
                ITPLE_set_neopixel_init: '네오픽셀 초기화 %1',
                ITPLE_set_neopixel: '%1 번째 네오픽셀 LED를 R: %2, G: %3, B: %4 색으로 켜기 %5',
            },
        },
        en: {
            template: {
                ...
                ITPLE_set_neopixel_init: 'Initialize NeoPixel %1',
                ITPLE_set_neopixel: 'Set NeoPixel %1 to R: %2, G: %3, B: %4 %5',
            },
        },
    };
};
    ...
    return {
        ...
        ITPLE_set_neopixel: {
            ...
            func(sprite, script) {
                ...
                const port = 100 + num; // 0번=100, 1번=101, 2번=102, 3번=103
            ...
            syntax: {
                ...
                py: [
                    {
                        syntax: 'Arduino.neopixelColor(9, %1, %2, %3, %4)',
                        textParams: [
                            {
                                type: 'Block',
                                accept: 'string',
